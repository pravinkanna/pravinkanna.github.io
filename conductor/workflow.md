...
2.  **Ensure Test Coverage for Phase Changes:**
    ...
    -   **Step 2.2: List Changed Files:** Execute `git diff --name-only <previous_checkpoint_sha> HEAD` (or similar command to track changes since last checkpoint) to get a precise list of all files modified during this phase.
...
### Before Committing
```bash
# Ensure production build is generated
npm run build
